...
@Component({
  selector: 'app-piloto-tipo',
  templateUrl: './piloto-tipo.component.html',
  styleUrls: ['./piloto-tipo.component.css']
})
export class PilotoTipoComponent implements OnInit {

  cargandoDatos: boolean = true;
  form: FormGroup;
  header: ItemHeaderComponent = {
    titulo: 'Tipo de Piloto',
    opciones: [
      {
