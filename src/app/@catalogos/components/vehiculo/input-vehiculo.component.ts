...
@Component({
  selector: 'app-input-vehiculo',
  templateUrl: './input-vehiculo.component.html',
  styleUrls: ['./input-vehiculo.component.css']
})
export class InputVehiculoComponent implements OnInit, OnDestroy {

  @Output() getItem = new EventEmitter<Vehiculo | Vehiculo[]>();
  @Input() tituloModal: string = "Seleccione Un Vehículo";
  ...
  constructor(private service: VehiculoService, private sweetService: SweetService) { }
