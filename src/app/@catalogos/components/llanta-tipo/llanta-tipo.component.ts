...
@Component({
  selector: 'app-llanta-tipo',
  templateUrl: './llanta-tipo.component.html',
  styleUrls: ['./llanta-tipo.component.css']
})
export class LlantaTipoComponent implements OnInit {

  cargandoDatos: boolean = true;
  form: FormGroup;
  header: ItemHeaderComponent = {
    titulo: 'Tipo de Llanta',
    opciones: [
      {
