...
@Component({
  selector: 'app-tipo-generador',
  templateUrl: './tipo-generador.component.html',
  styleUrls: ['./tipo-generador.component.css']
})
export class TipoGeneradorComponent implements OnInit {

  cargandoDatos: boolean = true;
  form: FormGroup;
  header: ItemHeaderComponent = {
    titulo: 'Tipo de Generador',
    opciones: [
      {
