...
export class TipoVehiculoService {
  ...
  private urlEndPoint: string = environment.UrlAguilaApi + "/api/tipoVehiculos";
  ...
  private listaDatos = new BehaviorSubject<TipoVehiculo[]>([]);
  ...
  setDatos(lista: TipoVehiculo[]) {
    this.listaDatos.next(lista);
  }

  getDatos(cargar: boolean = false): Observable<TipoVehiculo[]> {
