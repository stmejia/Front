...
@Component({
  selector: 'app-inspecciones-furgon',
  templateUrl: './inspecciones-furgon.component.html',
  styleUrls: ['./inspecciones-furgon.component.css']
})
export class InspeccionesFurgonComponent implements OnInit {
  ...
  constructor(private serviceComponent: CondicionFurgonService, private sweetService: SweetService,
  ...
  generarPdf(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Inspecciones De Furgón", bold: true, size: 18 }
      ]
    }
  ...
  generarExcel(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Inspecciones De Furgón", bold: true, size: 14 },
      ]
    }
