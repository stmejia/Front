...
@Component({
  selector: 'app-inspecciones-generador',
  templateUrl: './inspecciones-generador.component.html',
  styleUrls: ['./inspecciones-generador.component.css']
})
export class InspeccionesGeneradorComponent implements OnInit {
