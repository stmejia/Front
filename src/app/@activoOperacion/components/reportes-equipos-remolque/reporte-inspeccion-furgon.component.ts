...
@Component({
  selector: 'app-reporte-inspeccion-furgon',
  templateUrl: './reporte-inspeccion-furgon.component.html',
  styleUrls: ['./reporte-inspeccion-furgon.component.css']
})
export class ReporteInspeccionFurgonComponent implements OnInit {
