...
@Component({
  selector: 'app-reporte-inspeccion-equipo',
  templateUrl: './reporte-inspeccion-equipo.component.html',
  styleUrls: ['./reporte-inspeccion-equipo.component.css']
})
export class ReporteInspeccionEquipoComponent implements OnInit {
  ...
  generarPdf(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Inspecciones De Equipos", bold: true, size: 18 }
      ]
    }
  ...
  generarExcel(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Inspecciones De Equipos", bold: true, size: 14 },
      ]
    }
