...
@Component({
  selector: 'app-administracion-generador',
  templateUrl: './administracion-generador.component.html',
  styleUrls: ['./administracion-generador.component.css']
})
export class AdministracionGeneradorComponent implements OnInit {

  cargando: boolean = true;
  rutaComponent: string = "";
  equipo: Generador = null;
  ...
  header: ItemHeaderComponent = {
    titulo: 'Administración De Generador',
    opciones: [
      {
  ...
  constructor(private serviceComponent: ControlGeneradoresService,
  ...
  cargarPagina(noPagina) {
    this.serviceComponent.getMovimientosEquipo(this.equipo.idActivo, noPagina)
      .subscribe((res => {
