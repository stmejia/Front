...
@Component({
  selector: 'app-reporte-movimientos-generador',
  templateUrl: './reporte-movimientos.component.html'
})
export class ReporteMovimientosGeneradorComponent implements OnInit {
  ...
  header: ItemHeaderComponent = {
    titulo: 'Movimientos De Generadores',
    opciones: [
      {
  ...
  setFiltrosComponent() {
    let tipoEquipo = this.serviceComponent.getTiposGeneradoresValue();
  ...
  generarPdf(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Movimientos De Generador", bold: true, size: 18 }
      ]
    }
  ...
  generarExcel(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Movimientos De Generador", bold: true, size: 14 },
      ]
    }
