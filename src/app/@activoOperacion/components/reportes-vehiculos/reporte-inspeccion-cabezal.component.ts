...
@Component({
  selector: 'app-reporte-inspeccion-cabezal',
  templateUrl: './reporte-inspeccion-cabezal.component.html',
  styleUrls: ['./reporte-inspeccion-cabezal.component.css']
})
export class ReporteInspeccionCabezalComponent implements OnInit {
