...
@Component({
  selector: 'app-inspecciones-cabezal',
  templateUrl: './inspecciones-cabezal.component.html',
  styleUrls: ['./inspecciones-cabezal.component.css']
})
export class InspeccionesCabezalComponent implements OnInit {
  ...
  constructor(private serviceComponent: CondicionCabezalService, private sweetService: SweetService,
  ...
  cargarComponent() {
    ...
    this.serviceComponent.setConfiguracionComponent({
      header: {
        titulo: 'Inspecciones De Cabezal',
        opciones: [
          {
  ...
  generarPdf(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Inspecciones De Cabezal", bold: true, size: 18 }
      ]
    }
  ...
  generarExcel(evento) {
    let titulos: TitulosReporte = {
      ...
      subTitulos: [
        { text: "Inspecciones De Cabezal", bold: true, size: 14 },
      ]
    }
