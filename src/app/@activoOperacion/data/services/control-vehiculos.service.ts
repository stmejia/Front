...
export class ControlVehiculosService {

  private urlEndPoint: string = environment.UrlAguilaApi + "/api/controlVehiculos";
  ...
  private listaDatosReporteMovimientos = new BehaviorSubject<Vehiculo[]>([]);
  ...
  // Vehiculos
  getTiposVehiculos() {
    return this.vehiculosService.getTiposVehiculos();
  }
  ...
  getRecursoVehiculos() {
    return this.vehiculosService.getRecurso();
  }
