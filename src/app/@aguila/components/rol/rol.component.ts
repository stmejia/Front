...
export class RolComponent extends BaseComponent implements OnInit {
  ...
  constructor(protected s: RolService, protected sw: SweetService, protected ar: ActivatedRoute,
  ...
  cargarDatos() {
    ...
    if (this.validarParametro("id")) {
      ...
      this.s.consultar<Rol>(this.activatedRoute.snapshot.paramMap.get("id"))
        .subscribe(res => {
          if (res) {
